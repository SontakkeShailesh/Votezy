...
import in.zoro.votezy.repository.ElectionResultRepository;
...
public class ElectionResultService {
    ...
    @Autowired
    public ElectionResultService(CandidateRepository candidateRepository, ElectionResultRepository electionResultRepository,
    ...
    public ElectionResult declareElectionResult(String electionName){
        ...
        Candidate winner = allCandidates.get(0); // OrderBy so highest voting candidate will be at 0th position
        int totalVotes=0;
